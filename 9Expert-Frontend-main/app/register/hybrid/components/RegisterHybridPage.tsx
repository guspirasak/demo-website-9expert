...
export const RegisterHybridPage = () => {
    ...
    const classType = useSearchParams().get('type')
    ...
    const classTypeFn = () => {
        if (classType && classType.toLowerCase() === 'live') {
            return 'Live'
        } else if (classType && classType.toLowerCase() === 'classroom') {
            return 'Classroom'
        } else {
            return 'Classroom'
        }

...
export const RegisterForm = ({isInvalidTaxFirstName,isInvalidTaxLastName,isInvalidTaxCompanyName, setIsInvalidTaxFirstName,setIsInvalidTaxLastName,setIsInvalidTaxCompanyName}: {isInvalidTaxFirstName: boolean,isInvalidTaxLastName: boolean,isInvalidTaxCompanyName: boolean, setIsInvalidTaxFirstName:Function,setIsInvalidTaxLastName:Function,setIsInvalidTaxCompanyName:Function}) => {
    ...
    const { validate } = useValidateRegisterPublic()
                ...
                >
                    ...
                    >
                        <RegisterSelect
                            ...
                            isRequired
                            value={state.numberPerson.toString()}
                            isInvalid={validate.isNumberPerson}
                            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setState({ ...state, numberPerson: Number(e.target.value) })}
                        >
                            {
                    ...
                    <RegisterSelect
                        heading="ประเภทการสมัคร"
                        isRequired
                        value={state.type}
                        isInvalid={validate.isType}
                        onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setState({ ...state, type: e.target.value })}
                    >
                ...
                >
                    ...
                    >
                        <Checkbox
                            ...
                            onChange={() => setState({ ...state, requestReceipt: !state.requestReceipt })}
                        >
                            {`ต้องการใบเสนอราคา`}
                        </Checkbox>
                        <Checkbox
                            ...
                            onChange={() => setState({ ...state, requestInvoice: !state.requestInvoice })}
                        >
                            {`ต้องการใบแจ้งหนี้`}
                        </Checkbox>
                    </HStack>
                ...
                >
                    ...
                    >
                        ...
                        <RadioGroup
                            size='lg'
                            value={state.taxType}
                            onChange={(e) => setState({ ...state, taxType: e })}
                        >
                            <HStack
                                spacing='63px'
                            >

...
import { adminDeleteCourse, adminDeleteMultipleCourse, getAllOnlineCourseTable } from "@/libs/AdminAPI"
...
export const OnlineCourseTablePage = () => {
    ...
    useEffect(() => {
        getAllOnlineCourseTable(page as string, (data: { result: TCourseTable[], count: number }, error: unknown) => {
            ...
            >
                ...
                >
                    <HStack
                        ...
                        m='0'
                    >
                        <Heading fontSize='1.5rem'>{`หลักสูตร E-learnning`}</Heading>
                        <HStack>
                            <Button
                                as={Link}
                                href='/admin?tab=elearning-course&action=create'
                                color='white'
                                bg='exBlue'
                                _hover={{
                                    bg: 'exBlue'
                                            ...
                                            <Tr key={index}>
                                                ...
                                                >
                                                    <HStack>
                                                        ...
                                                        />
                                                        <Link
                                                            href={`/admin?tab=elearning-course&action=edit&course=${course._id}`}
                                                        >
                                                            <Text fontSize='md' fontWeight='400' textColor='#2E2E2E' >{course.courseName}</Text>
                                                        </Link>
                                                    </HStack>
                                                </Td>
                                                <Td
                ...
                <AdminPagination
                    page={Number(page)}
                    count={count}
                    url={`/admin?tab=elearning-course&page=`}

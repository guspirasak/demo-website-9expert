...
import { createTechnologyArea } from "@/libs/AdminAPI"
import { imageToBase64, TImageToBase64Result } from "@/libs/ImageToBase64"
import { AddIcon } from "@chakra-ui/icons"
import { useToast, useDisclosure, HStack, Button, Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, Stack, Input, Text, Image } from "@chakra-ui/react"
import { useState, useRef } from "react"
import { Loading } from "../../Loading"
import { TCreateTechnologyArea } from "@/app/admin/interface/TechnologyAreaInterface"

export const AreaModal = ({ setUpdate }: { setUpdate: React.Dispatch<React.SetStateAction<boolean>> }) => {
    ...
    const onHandleSave = async () => {
        ...
        await createTechnologyArea(state, (data: TCreateReview, error: string) => {
